...
#Recommend doing past the first 2 pages and less than 10 pages at once
for page in range (5,6):
    ...
    for btn in connect_buttons:
        ...
        driver.implicitly_wait(5)
        #Change message here
        message = (f"Hi {name}!\n I hope this message finds you well. I just wanted to reach out and connect with you on LinkedIn. Let's connect and keep in touch. Best regards, \n Ben Holmes")
